...
export default function InstallationPage() {
  ...
  const content = {
    en: {
      title: "Installation",
      description: "Get started with NextLib by installing it in your project",
      maven: `<dependency>
    <groupId>com.nextlib</groupId>
    <artifactId>nextlib</artifactId>
    <version>1.0.0</version>
</dependency>`,
      gradle: `dependencies {
    implementation 'com.nextlib:nextlib:1.0.0'
}`,
      setup: "Add NextLib to your plugin.yml:",
...
depend:
  - NextLib`,
    ...
    ru: {
      title: "Установка",
      description: "Начните работу с NextLib, установив его в ваш проект",
      maven: `<dependency>
    <groupId>com.nextlib</groupId>
    <artifactId>nextlib</artifactId>
    <version>1.0.0</version>
    ...
    implementation 'com.nextlib:nextlib:1.0.0'
      ...
      setup: "Добавьте NextLib в ваш plugin.yml:",
      pluginYml: `name: MyPlugin
version: 1.0.0
main: com.example.MyPlugin
depend:
  ...
  return (
    <DocPage title={current.title} description={current.description}>
      <section className="space-y-8">
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4">{current.setup}</h2>
        ...
        <div className="bg-card border border-border rounded-lg p-6 mt-8">
          ...
          <p className="text-muted-foreground">
            After installation, check out the Quick Start guide to learn how to use NextLib in your plugin.
          </p>
        </div>
      </section>
    </DocPage>
